...
import CommunityTreasuryCardNew from "../../components/communitySpace/CommunityTreasuryCardNew";
  ...
  function Avatar({ avatar }: AvatarProps) {
    ...
    return (
      <div style={{ width: 36, borderRadius: "50%", overflow: "hidden", display: "flex", justifyContent: "center"}}>
        <img 
          src={error.hasError ? "/org3-img-error.jpg" : avatar} 
          alt="avatar" 
          onError={() => setError({ hasError: true })}
...
const columns: ColumnsType<DataType> = [
    {
        title: '',
        dataIndex: 'avatar',
        render: (avatar: string) => <Avatar avatar={avatar} />,
    },
    {
        title: 'Primary Name',
        dataIndex: 'name',
